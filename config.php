...
function app_head_assets(): string
{
    ...
    $modernCss = htmlspecialchars(app_absolute_url('assets/modern.css?v=25'), ENT_QUOTES, 'UTF-8');
    $modernJs = htmlspecialchars(app_absolute_url('assets/modern.js?v=25'), ENT_QUOTES, 'UTF-8');
