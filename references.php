    ...
    <section class="grid gap-7 md:grid-cols-[0.95fr_1.05fr] md:items-center" data-reveal-section-static>
        <div class="max-w-2xl">
            ...
            <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                <a href="rezervace.php" class="inline-flex items-center justify-center rounded-lg bg-[var(--accent)] px-5 py-3 text-sm font-semibold text-[color:var(--cream)] transition hover:bg-[var(--accent-dark)] focus:outline-none focus:ring-2 focus:ring-[var(--gold)]">
                    Přejít na rezervaci
                </a>
